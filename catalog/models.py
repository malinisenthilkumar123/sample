...
from django.urls import reverse  # type: ignore # To generate URLS by reversing URL patterns
...
from django.conf import settings  # type: ignore # Required to assign User as a borrower
...
class BookInstance(models.Model):
    ...
    imprint = models.CharField(max_length=200)
    due_back = models.DateField(null=True, blank=True)  # Ensure this field exists
